...
def main():
    ...
    alphabet = [
        ...
        {'russian': 'Е', 'english': 'ye', 'hint': 'Еда, "yeda" = food, looks like a fork'},
        ...
        {'russian': 'Х', 'english': 'ch', 'hint': 'bach, Херсон'},
        ...
        {'russian': 'Щ', 'english': 'sch', 'hint': "sounds like 'sh' and 'ch' together, ща = shcha/soon "},
        {'russian': 'Э', 'english': 'e', 'hint': 'met, EUR '},
        {'russian': 'Ю', 'english': 'yu', 'hint': 'IO you'},
        {'russian': 'Я', 'english': 'ya', 'hint': 'Ялта, yalta'},
    ]
